...
const LiveProjects = () => {
    ...
    const projectDetails = useSelector(state => state.launchpad.liveProjects);
                ...
                <div className="sec-inner align-items-center d-flex justify-content-between mb-30">
                    <div className="sec-heading">
                        <div className="sub-inner mb-15">
                            <span className="sub-title">Proceeding Projects</span>
                            ...
                            <div className="project-item hover-shape-border">
                                <div className="project-info d-flex">
                                    ...
                                    <div className="project-auother">
                                        ...
                                        <div className="dsc">1 BNB = {Math.round(projectDetail.price * 1e10) / 1e10 + projectDetail.symbol} </div>
                                    </div>
                                </div>
